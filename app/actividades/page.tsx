        ...
        <section className="container mx-auto px-4 py-8 sm:py-12">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-lg sm:text-xl mb-6 leading-relaxed">
              ...
              que va m&aacute;s all&aacute; del aula. Nuestras actividades
              est&aacute;n dise&ntilde;adas para fomentar la curiosidad, la
              creatividad y el amor por la naturaleza en nuestros estudiantes.
            </p>
          </div>
        </section>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <ul className="space-y-4">
              <li className="flex items-center">
                <span className="w-32 font-semibold">9 de Agosto:</span>
                <span>Actividades del Día del Niño y la Niña</span>
              </li>
              <li className="flex items-center">
                <span className="w-32 font-semibold">11 de Septiembre:</span>
                <span>Competencia de Debate de Escuelas Municipales</span>
              </li>
              <li className="flex items-center">
                <span className="w-32 font-semibold">12 de Septiembre:</span>
                <span>Acto de Fiestas Patrias</span>
              </li>
              <li className="flex items-center">
                <span className="w-32 font-semibold">13 de Septiembre:</span>
                <span>Celebración de Fiestas Patrias con juegos típicos</span>
              </li>
            </ul>
          </div>
        </section>
